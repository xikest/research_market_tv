...
class ModelScraper_s(Scraper):
    ...
    def get_models_info(self, format_df:bool=True, temporary_year_marking:bool=True):
        """
    ...
    def _get_global_spec(self, url: str, dict_models, key: str):
        ...
        for cnt_try in range(try_total):
            try:
                ...
                dict_spec.update(extract_model_info(dict_spec.get("model")))
                ...
                for _ in range(15):
                    ...
                    for element in elements:
                        ...
                        dict_spec.update(soup_to_dict(soup))
