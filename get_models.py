...
from market_research.scraper.models import SONYSPEC, SONYJPSPEC, PANASONICSPEC
...
mssjp = SONYJPSPEC(webdriver_path = webdriver_path, browser_path=browser_path, enable_headless=enable_headless)
